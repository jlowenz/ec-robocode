 ...
 * </b>
 */
public class IfThenElse extends GPRoboNode {
    private static final long serialVersionUID = 5736439131288094652L;
    ...
    public void eval(final EvolutionState state, final int thread, final GPData input, final ADFStack stack, final GPIndividual individual, final Problem problem) {
        ...
        int which = (cond) ? 1 : 2;
        children[which].eval(state,thread,input,stack,individual,problem);
    }
}
